...
* File permissions from 1.2.2 (editors respect file permissions; read-only files require `:w!` or `sudo`)

* `grep` and `find` from 1.8.1 (searching before editing)

* `sed` and `awk` from 1.8.2 (automated editing vs manual editing with vim/nano)
