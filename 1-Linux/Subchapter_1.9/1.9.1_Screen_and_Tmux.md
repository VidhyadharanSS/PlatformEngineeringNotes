...
- [1.6.1 Process Management](../Subchapter_1.6/1.6.1_Process_Lifecycle_and_Tools.md) – Multiplexers run as processes; you can `kill` detached sessions
- [1.4.1 SSH Fundamentals](../Subchapter_1.4/1.4.2_Key_Pair_Authentication.md) – Multiplexers are essential for remote work to survive disconnects
