...
* Process management from 1.6.1 (multiplexers run as processes; you can `kill` detached sessions)

* SSH from 1.4.x (multiplexers are essential for remote work to survive disconnects)

* `watch` command used in lab (repeatedly executes a command – introduced in the tmux task)
