...
> **If your infrastructure doesn't use GPUs**, this entire subchapter is optional. Skip it and move to 1.10 (Troubleshooting).
...
## Part 8: GPU in Containers — nvidia-container-toolkit (Preview — Modules 4 & 5)

> **Note:** This section previews Docker and Kubernetes concepts covered in depth in Module 4 (Docker) and Module 5 (Kubernetes). It's included here for completeness in the GPU management workflow. If you haven't studied containers yet, bookmark this and return after Module 4.
