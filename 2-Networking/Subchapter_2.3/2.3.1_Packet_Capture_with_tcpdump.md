...
* TCP flags from OSI transport layer (2.1.1)

* IP addressing and ports from 2.1.2

* ICMP protocol from 2.2.1 (ping uses ICMP)

* Port numbers from 2.1.1 (HTTP=80, HTTPS=443, SSH=22, DNS=53)
