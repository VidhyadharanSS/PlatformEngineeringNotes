...
> **Warning:** A growing `CLOSE_WAIT` count means your application is not closing sockets properly — this is a code bug. A high `TIME_WAIT` count is normal under load but can cause port exhaustion. Tune with `net.ipv4.tcp_tw_reuse=1`.
