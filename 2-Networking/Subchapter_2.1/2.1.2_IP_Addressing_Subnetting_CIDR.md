...
The **default gateway** is the router that forwards traffic to destinations outside your local subnet. Without a gateway, you can only communicate with devices on your own network.
