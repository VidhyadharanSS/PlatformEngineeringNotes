...
* IP addressing from 2.1.2 (A/AAAA records map to IPs)

* `ping` and `traceroute` from 2.2.1 (testing DNS resolution vs IP reachability)

* `/etc/resolv.conf` mentioned in 2.2.1 for DNS configuration
