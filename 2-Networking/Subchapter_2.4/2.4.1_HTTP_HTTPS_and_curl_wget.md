...
CORS prevents a web page on `site-a.com` from making API calls to `site-b.com` without permission. As a platform engineer, you'll debug CORS errors when frontends can't reach backends.
