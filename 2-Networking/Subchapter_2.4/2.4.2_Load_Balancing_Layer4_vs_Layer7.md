...
* OSI layers from 2.1.1 (Layer 4 vs Layer 7 distinction)

* TCP/UDP from 2.1.1 (Layer 4 protocols)

* HTTP from 2.4.1 (Layer 7 content)

* IP addressing from 2.1.2 (VIPs, backend IPs)

* Firewalling from 2.3.2 (health checks may be blocked)
