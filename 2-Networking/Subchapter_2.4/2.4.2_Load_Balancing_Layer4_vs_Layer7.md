...
### Kubernetes Load Balancing (Preview — Module 5)

> **Note:** These Kubernetes components are covered in depth in Module 5. This table is a preview showing how load balancing concepts apply in container orchestration.
...
> **Reading HAProxy/Nginx config files:** These configs follow a consistent structure:
> - **global/main** — Process-level settings (how many connections, logging)
> - **frontend** — The "door" where clients connect (bind an IP:port, pick rules)
> - **backend** — The "room" with your actual servers (list of server IPs, health checks, algorithm)
> - A frontend routes to a backend. That's the core mental model.
