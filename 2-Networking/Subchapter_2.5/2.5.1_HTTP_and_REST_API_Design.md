...
**Next note:** [5.7.4 — Authentication and Authorization](5.7.4_Authentication_and_Authorization.md)
...
- [ ] Auth required ([5.7.4](5.7.4_Authentication_and_Authorization.md))
...
Next: [5.7.4 — Authentication and Authorization](5.7.4_Authentication_and_Authorization.md) — keys, JWTs, OAuth2, mTLS, and which one to pick for your service.
