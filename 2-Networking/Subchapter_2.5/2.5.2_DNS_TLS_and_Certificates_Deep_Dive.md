# 2.5.2 DNS, TLS, and Certificates Deep Dive

**Backlinks:** [2.3 DNS & TLS Basics](../../2-Networking/) · [7.3 Nginx SSL](../../7-Nginx/) · [5.7.4 — Auth (mTLS)](../../5-Kubernetes/Subchapter_5.7/5.7.4_Authentication_and_Authorization_for_Platforms.md)

**Next note:** [9.6.3 — Data Formats and Serialization](../../9-Python/Subchapter_9.6/9.6.3_Data_Formats_and_Serialization.md)
...
- [ ] Runbook for: cert didn't renew, DNS outage, TLS errors ([5.8.9](../../5-Kubernetes/Subchapter_5.8/5.8.9_Incident_Response_and_On_Call.md))
...
Next: [9.6.3 — Data Formats and Serialization](../../9-Python/Subchapter_9.6/9.6.3_Data_Formats_and_Serialization.md) — JSON, YAML, Protobuf, and the pitfalls that wreck interoperability.
