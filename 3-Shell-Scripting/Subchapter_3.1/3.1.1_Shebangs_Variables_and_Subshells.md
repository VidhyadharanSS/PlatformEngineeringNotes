...
* Command-line basics from Module 1 (commands used in subshells)

* Exit codes from Module 1 (`$?` is the exit code of the last command)

* File permissions from Module 1 (`chmod +x` for scripts)
