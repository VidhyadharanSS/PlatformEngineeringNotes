...
| 4 | **Strict mode** — we add this line out of habit for now. In short: `-e` stops the script on errors, `-u` catches typos in variable names, `-o pipefail` catches errors in piped commands. Note 3.2.1 explains exactly why each flag matters. |
