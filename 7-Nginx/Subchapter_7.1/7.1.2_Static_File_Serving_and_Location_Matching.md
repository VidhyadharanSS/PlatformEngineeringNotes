...
**Next note (7.1.3)** will be the Subchapter Review for Nginx Core Concepts, including a cheatsheet and scenario-based interview questions.

**Backward references:**
- Filesystem paths from Module 1 (document root)
- HTTP caching from Module 2 (Cache-Control headers)
