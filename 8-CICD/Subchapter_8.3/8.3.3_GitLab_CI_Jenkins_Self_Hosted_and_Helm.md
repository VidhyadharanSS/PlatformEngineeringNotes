...
> **Analogy:** Jenkins is like a construction company — the **Controller** is the project manager who plans and coordinates, and the **Agents** are the construction workers who do the actual building. The project manager doesn’t lift bricks; it dispatches work to available workers.
...
> **Note:** Jenkins pipelines are written in **Groovy** — a JVM scripting language similar to Java but with Python-like shortcuts. You don't need to learn Groovy deeply; the Declarative Pipeline syntax (below) reads almost like plain English.
...
> **⚠️ Advanced (skip on first pass):** Shared Libraries are for teams managing 10+ repos with Jenkins. Come back here once you're comfortable with basic Jenkinsfiles.
