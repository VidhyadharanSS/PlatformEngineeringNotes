### 8.1.3 Subchapter Review: Cheatsheet and Interview Prep
...
| `--changedSince` | Jest flag to only run tests for changed files |
| `.trivyignore` | File to ignore specific CVEs (with reason) |
| Dependabot | GitHub tool that automatically updates dependencies |
| Canary deployment | Deploy to small percentage of users first |
| Feature flags | Toggle features on/off without redeploying |

---

**End of Subchapter 8.1 Review**

**Next:** Proceed to Subchapter 8.2 – Pipeline as Code with GitHub Actions (workflow syntax, building and testing, publishing artifacts).

Congratulations on completing Subchapter 8.1! You now understand CI/CD fundamentals, pipeline stages, and how automation transforms software delivery.
