...
> **Analogy:** The test pyramid is like building a house — the foundation (unit tests) is wide and cheap, walls (integration tests) are fewer, and the roof (E2E tests) sits on top. If your foundation is weak, everything above collapses.
...
> **Note:** Deployment strategies are previewed here for context. For full details with examples, see [8.3.1 — Deployment Strategies Explained](../Subchapter_8.3/8.3.1_Deployment_Strategies_Explained.md).
