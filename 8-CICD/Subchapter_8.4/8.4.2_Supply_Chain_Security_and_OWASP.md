# 8.4.2 Supply Chain Security and OWASP

**Backlinks:** [5.7.5 — Secrets Management](../../5-Kubernetes/Subchapter_5.7/5.7.5_Secrets_Management_Deep_Dive.md) · [4.5 Docker Security](../../4-Docker/) · [8.4 CI Security](../../8-CICD/)

**Next note:** [5.8.7 — Three Pillars of Observability](../../5-Kubernetes/Subchapter_5.8/5.8.7_Three_Pillars_Metrics_Logs_Traces.md)
...
> **Analogy:** An SBOM is like a food ingredient label. Just as the label tells you that your cereal contains wheat, sugar, and palm oil — an SBOM tells you that your container contains Python 3.12, Flask 3.0.2, and OpenSSL 3.2.1. When a recall happens (a CVE drops), you check the label instead of taste-testing everything.
...
> **⚠️ Advanced (skip on first pass):** SLSA is a maturity framework for build security. Understand the concept (builds should be automated and auditable), but don't worry about the specific levels until your org starts a formal security program.
...
**Defense:** [5.7.4](../../5-Kubernetes/Subchapter_5.7/5.7.4_Authentication_and_Authorization_for_Platforms.md) — server-side AuthZ on every endpoint, default deny, test with a non-admin account.
...
- Secrets in logs. See [5.7.5](../../5-Kubernetes/Subchapter_5.7/5.7.5_Secrets_Management_Deep_Dive.md).
...
**Defense:** immutable infra via IaC ([10.4.1](../../10-GitOps-ArgoCD/Subchapter_10.4/10.4.1_Cloud_Primitives_and_IaC.md)), policy-as-code (OPA / Kyverno).
...
Covered in [5.7.4](../../5-Kubernetes/Subchapter_5.7/5.7.4_Authentication_and_Authorization_for_Platforms.md).
...
Covered in [5.8 Operations](../../5-Kubernetes/Subchapter_5.8/).
...
2. **Long-lived cloud keys in CI.** Use OIDC federation; [5.7.5](../../5-Kubernetes/Subchapter_5.7/5.7.5_Secrets_Management_Deep_Dive.md).
...
Next: [5.8.7 — Three Pillars of Observability](../../5-Kubernetes/Subchapter_5.8/5.8.7_Three_Pillars_Metrics_Logs_Traces.md) — metrics, logs, and traces.
