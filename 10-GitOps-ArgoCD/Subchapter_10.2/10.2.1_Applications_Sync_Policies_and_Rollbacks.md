...
**Backward references:** Kubernetes from Module 5 (manifests, namespaces); Git from Module 6 (repositories); Helm from Module 5 (charts); Kustomize from Module 5 (overlays).
