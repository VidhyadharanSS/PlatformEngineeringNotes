...
**Backlinks:** [Module 1 - Linux CLI](../../1-Linux/Subchapter_1.1/1.1.2_CLI_Basics_and_Philosophy.md) (terminal commands used throughout) | [Module 3 - Shell Scripting](../../3-Shell-Scripting/Subchapter_3.1/3.1.1_Shebangs_Variables_and_Subshells.md) (scripts used in hooks/automation)

**Next note:** [6.1.2 - Essential Git Commands](./6.1.2_Essential_Git_Commands_and_Configuration.md)

---

#### Why Git Internals Matter

> **💡 Just want to use Git right now?** Skip to [6.1.2 - Essential Commands](./6.1.2_Essential_Git_Commands_and_Configuration.md). Come back here once you're comfortable with add/commit/push — understanding internals will make everything else click.
...
> **Analogy:** Git is like a library where every book is filed by a unique fingerprint of its contents, not by title. If two files have identical text, Git stores only one copy. A **commit** is like a dated photograph of your entire project folder. The **tree** is the folder structure in that photo, and **blobs** are the individual file contents captured at that moment.
...
> **🔖 Advanced — skip on first pass.** This transition won't affect your daily workflow yet. SHA-1 remains the default in all major Git hosts.

Git is transitioning from SHA-1 (vulnerable to collision attacks) to SHA-256. Understanding the current state matters for long-term repository planning.

```bash
# Create a SHA-256 repository (Git 2.29+, experimental)
git init --object-format=sha256

# Check which hash your repository uses
git rev-parse --show-object-format
# sha1        (default, most repos)
# sha256      (new format)

# SHA-1 produces 40-character hashes
git rev-parse HEAD
# a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2

# SHA-256 produces 64-character hashes
# a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2
```

**Practical implications:**

| Aspect | SHA-1 (Current Default) | SHA-256 (Future) |
|--------|------------------------|------------------|
| **Hash length** | 40 chars | 64 chars |
| **Security** | Vulnerable to SHAttered attack | Collision-resistant |
| **Interoperability** | Universal support | Cannot push to SHA-1 remotes |
| **Status (2024)** | Production standard | Experimental — avoid for production |
| **Migration** | N/A | No in-place conversion yet; requires fresh repo |

**When to use SHA-256:**
- **Now:** Only for isolated experiments or internal repos where interop isn't needed
- **Future:** GitHub/GitLab will announce migration paths — wait for ecosystem support
- **Key takeaway:** Be aware of the transition, but don't switch production repos yet
...
> **🔖 Advanced — skip on first pass.** Git automatically compresses old objects — you don't need to manage this manually. This section explains *how* it works under the hood.
