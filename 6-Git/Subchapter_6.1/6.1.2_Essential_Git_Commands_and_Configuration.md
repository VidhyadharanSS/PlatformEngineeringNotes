...
# Shallow clone (only latest snapshot, not full history — much faster for large repos you only need to read)
git clone --depth 1 https://github.com/user/repo.git

# Clone with all submodules (nested repositories — explained in 6.4.2)
...
# Stage interactively (patch mode) — lets you commit parts of a file
git add -p
# A "hunk" is a contiguous block of changes. Choose: y=stage, n=skip, s=split into smaller hunks, e=edit manually
