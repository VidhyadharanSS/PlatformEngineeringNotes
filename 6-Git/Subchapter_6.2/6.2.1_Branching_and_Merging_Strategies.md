...
Think of a branch as a sticky note you place on the latest page of your notebook. When you write a new page (commit), the sticky note moves forward automatically. Multiple sticky notes on different pages = multiple branches.
