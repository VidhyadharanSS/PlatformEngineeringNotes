...
## Part 5: Container-to-Container Communication
...
## Part 7: Overlay Network (Multi-Host)
...
* Network namespaces from 4.1.1 (each container has its own)

* IP addressing and subnetting from Module 2 (bridge subnet configuration)

* iptables from Module 2 (Docker uses NAT for port publishing)

* DNS from Module 2 (user-defined bridge provides DNS resolution)
