...
* Dockerfile basics from 4.2.1 (instructions, layer caching)

* User management from Module 1 (non-root user in containers)

* Package management from Module 1 (apt, apk commands)

* Build tools from Module 1 (compiling from source concepts)
