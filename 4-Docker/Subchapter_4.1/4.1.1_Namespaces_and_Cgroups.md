...
* Process management from Module 1 (PID namespace relates to `ps`, `kill`)

* Networking from Module 2 (NET namespace relates to IP addresses, ports)

* Filesystem from Module 1 (MNT namespace relates to mount points, rootfs)

* User management from Module 1 (USER namespace relates to UID mapping)
