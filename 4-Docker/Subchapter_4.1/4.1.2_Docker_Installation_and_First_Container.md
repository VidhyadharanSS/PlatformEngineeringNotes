...
## Part 8: Cleanup and Housekeeping
...
* Namespaces and cgroups from 4.1.1 (Docker uses these under the hood)

* Systemd from Module 1 (starting Docker as a service)

* Networking from Module 2 (port publishing `-p 8080:80`)

* Process management from Module 1 (`docker top` shows processes inside container)
