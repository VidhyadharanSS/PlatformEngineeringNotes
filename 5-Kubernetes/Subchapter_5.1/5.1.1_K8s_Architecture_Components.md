...
**Backward references:** Container concepts from Module 4 (containerd, runc) are used by the kubelet. Networking from Module 2 (iptables, DNS) is used by kube-proxy and CoreDNS.
...
## Part 3: Worker Node Components (The Muscles)
...
## Part 4: Addons (Essential but Not Required)
...
## Part 5: Pods – The Smallest Deployable Unit
...
## Part 6: kubectl – The CLI Swiss Army Knife
...
* Container runtimes from Module 4 (containerd, runc)

* Networking iptables from Module 2 (kube-proxy uses iptables)

* Linux processes from Module 1 (kubelet runs as systemd service)

* Docker concepts from Module 4 (images, containers)
