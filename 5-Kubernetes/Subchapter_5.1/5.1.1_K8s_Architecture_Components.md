...
**Backlinks:** [Module 4 - Container Basics](../../4-Docker/Subchapter_4.1/4.1.1_Namespaces_and_Cgroups.md) (containerd, runc used by kubelet) | [Module 2 - Networking](../../2-Networking/Subchapter_2.3/2.3.2_Firewalling_with_iptables_nftables.md) (iptables, DNS used by kube-proxy and CoreDNS)
...
> **Don't worry about RBAC and Admission Controllers yet** — they're covered in 5.8. For now, just know they're checkpoints the request passes through (like security guards checking your badge before letting you into a building).
...
> **Plain-language:** Quorum is like a vote — in a group of 3 nodes, at least 2 must agree before a decision counts. That's why you always run an odd number of etcd members.
...
> **📖 Reference section** — you'll install these as needed throughout the module. Come back here after 5.4 (Services/Ingress) and 5.9 (Monitoring) when you need the install commands.
...
## Part 8: kubectl explain – Built-In API Documentation

`kubectl explain` is the most underrated kubectl feature. It gives you the full API schema without leaving the terminal — critical for CKA/CKAD exams where you can't access external docs.
...
# Explain nested fields (dot notation)
kubectl explain pod.spec.containers
kubectl explain pod.spec.containers.livenessProbe
kubectl explain pod.spec.containers.resources.limits

# Recursive – show ALL fields at once (exam lifesaver)
kubectl explain pod.spec --recursive
kubectl explain deployment.spec --recursive | head -80

# Pipe to grep for quick field lookup
kubectl explain pod.spec --recursive | grep -i "restart"
# restartPolicy	<string>

kubectl explain deployment.spec --recursive | grep -i "strategy"
# strategy	<Object>
...
# Find the exact path for a field
kubectl explain pod.spec.restartPolicy
# FIELD: restartPolicy <string>
# What host IP to bind the external port to.
# Possible values: Always, OnFailure, Never

# API version for a resource
kubectl explain cronjob --api-version=batch/v1
```

**Pro tip for exams:** When you forget a field name, run `kubectl explain <resource>.spec --recursive | grep -i <keyword>` instead of searching documentation. It's faster and always accurate for your cluster's API version.

### Common `kubectl explain` Patterns

| Command | Purpose |
|---------|---------|
| `kubectl explain pod.spec --recursive` | All pod spec fields |
| `kubectl explain deploy.spec.strategy` | Deployment strategies |
| `kubectl explain svc.spec.type` | Service types |
| `kubectl explain ingress.spec.rules` | Ingress rule structure |
| `kubectl explain pvc.spec` | PVC spec fields |
| `kubectl explain sa` | ServiceAccount fields |

***

## Part 9: kubectl – The CLI Swiss Army Knife
...
> **⏭️ Bookmark for later** — use these once you're comfortable with the full commands. Learning the full `kubectl get pods` first builds muscle memory; aliases speed you up later.
...
**Backlinks:** [Module 4 - Docker](../../4-Docker/Subchapter_4.1/4.1.1_Namespaces_and_Cgroups.md) (containerd, runc) | [Module 2 - Networking](../../2-Networking/Subchapter_2.3/2.3.2_Firewalling_with_iptables_nftables.md) (iptables) | [Module 1 - Linux](../../1-Linux/Subchapter_1.6/1.6.1_Process_Lifecycle_and_Tools.md) (kubelet as systemd service)
