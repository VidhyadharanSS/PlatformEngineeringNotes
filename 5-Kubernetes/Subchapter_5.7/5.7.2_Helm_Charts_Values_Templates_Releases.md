...
**Backward references:** Kubernetes YAML from previous subchapters (charts generate YAML); ConfigMaps/Secrets from 5.6.1; Deployments from 5.3.1.
...
* Kubernetes YAML from previous subchapters (templates generate YAML)

* ConfigMaps/Secrets from 5.6.1 (configMapGenerator in Kustomize)

* Deployments from 5.3.1 (templates include deployment)

* HPA from 5.6.2 (autoscaling template)
