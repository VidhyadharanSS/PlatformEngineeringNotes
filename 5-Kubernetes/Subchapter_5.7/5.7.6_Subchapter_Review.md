# 5.7.6 Subchapter Review: Authentication, Authorization, and Admission Control

This review covers the material presented in Notes 5.7.1 (Authentication Methods), 5.7.2 (RBAC Deep Dive), and 5.7.3 (Admission Controllers).

**Backlinks:** [5.7.1 - Authentication](5.7.1_Authentication_Methods.md) | [5.7.2 - RBAC](5.7.2_RBAC_Deep_Dive.md) | [5.7.3 - Admission Controllers](5.7.3_Admission_Controllers.md)
...
| Topic | Found in Note |
|-------|---------------|
| X.509 Certificate authentication | 5.7.1 |
| ServiceAccount tokens | 5.7.1 |
| OIDC authentication | 5.7.1 |
| Webhook token authentication | 5.7.1 |
| User impersonation | 5.7.1 |
| Roles and ClusterRoles | 5.7.2 |
| RoleBindings and ClusterRoleBindings | 5.7.2 |
| RBAC verbs and API groups | 5.7.2 |
| Built-in ClusterRoles (admin, edit, view) | 5.7.2 |
| kubectl auth can-i | 5.7.2 |
| Pod Security Standards (PSS) | 5.7.3 |
| Mutating admission webhooks | 5.7.3 |
| Validating admission webhooks | 5.7.3 |
| OPA Gatekeeper | 5.7.3 |
| Kyverno policies | 5.7.3 |

---

**End of Subchapter 5.7 Review**

**Next:** Proceed to [Subchapter 5.8](../Subchapter_5.8/5.8.1_Troubleshooting_Control_Plane.md) – Troubleshooting, Monitoring, Dashboard Tools, kubectl Cheatsheet + JSONPath, and Final Module 5 Exam.
