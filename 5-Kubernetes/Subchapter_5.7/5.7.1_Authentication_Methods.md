# 5.7.1 Kubernetes Authentication Methods: Proving Your Identity
...
> **Analogy:** A Service Account token is like an employee badge — it identifies the pod to the API server. Projected tokens are badges that expire after 1 hour (more secure than permanent badges).
>
> **The split:** Humans use certificates or OIDC (SSO). Pods use Service Accounts — Kubernetes handles the token automatically. Most of this chapter focuses on certificates (CKA exam) but in practice, most teams use OIDC for human access.

This note covers authentication methods. Note 5.7.2 covers RBAC authorization; note 5.7.3 covers Admission Controllers.

**Backlinks:** [5.1.1 - API Server](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md) | [5.5.1 - Secrets](../Subchapter_5.5/5.5.1_ConfigMaps_and_Secrets.md) | [Module 1 - SSH Keys](../../1-Linux/Subchapter_1.4/1.4.2_Key_Pair_Authentication.md)
...
**Next note (5.7.2)** will cover **RBAC Deep Dive** – Roles, ClusterRoles, RoleBindings, ClusterRoleBindings, and common RBAC patterns.

**Backlinks:** [5.1.1 - API Server](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md) | [5.5.1 - Secrets](../Subchapter_5.5/5.5.1_ConfigMaps_and_Secrets.md) | [Module 1 - SSH](../../1-Linux/Subchapter_1.4/1.4.2_Key_Pair_Authentication.md)
