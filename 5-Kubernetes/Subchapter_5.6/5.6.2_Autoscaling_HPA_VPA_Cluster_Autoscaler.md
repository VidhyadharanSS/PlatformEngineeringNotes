...
**Backward references:** Deployments from 5.3.1 (HPA scales replicas); resource requests/limits from Module 4 (metrics based on requests); metrics-server from 5.1.2 (provides CPU/memory metrics).
...
* metrics-server from 5.1.2 (provides CPU/memory metrics)

* Deployments from 5.3.1 (HPA scales deployments)

* Resource requests/limits from Module 4 (HPA uses request values)

* Prometheus from Module 5 (custom metrics source)
