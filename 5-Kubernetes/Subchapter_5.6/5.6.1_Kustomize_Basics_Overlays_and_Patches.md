# 5.6.1 Kustomize Basics: Overlays and Patches – Template-Free Customization
...
This note covers Kustomize fundamentals. Note 5.6.2 covers Helm; note 5.6.3 is the subchapter review.

**Backlinks:** [5.2.1 - Workloads](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md) (Kubernetes YAML, namespaces) | [5.5.1 - ConfigMaps](../Subchapter_5.5/5.5.1_ConfigMaps_and_Secrets.md) (configMapGenerator)

***

## Part 1: Kustomize Overview

Think of Kustomize like a base recipe (base/) with variations: "for kids, reduce spice" (overlay/dev), "for guests, double portion" (overlay/prod). The base recipe stays unchanged — overlays only describe what's *different*.
...
**Next note (5.6.2)** will cover **Helm Charts, Values, Templates, and Releases** – Helm architecture, chart structure, templating, and release management.

**Backlinks:** [5.2.1 - Workloads](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md) (Deployment, Service) | [5.5.1 - ConfigMaps](../Subchapter_5.5/5.5.1_ConfigMaps_and_Secrets.md) (configMapGenerator) | [5.5.2 - Autoscaling](../Subchapter_5.5/5.5.2_Autoscaling_HPA_VPA_Cluster_Autoscaler.md) (HPA)
