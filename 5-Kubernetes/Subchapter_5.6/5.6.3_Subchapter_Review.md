...
This review covers only the material presented in Notes 5.6.1 (Kustomize Basics) and 5.6.2 (Helm Charts, Values, Templates, Releases). No forward referencing beyond what was explicitly introduced.

**Backlinks:** [5.6.1 - Kustomize](5.6.1_Kustomize_Basics_Overlays_and_Patches.md) | [5.6.2 - Helm](5.6.2_Helm_Charts_Values_Templates_Releases.md)
...
| Topic                                                              | Found in Note |
| ------------------------------------------------------------------ | ------------- |
| Kustomize directory structure (base/overlays)                      | 5.6.1         |
| Kustomize base kustomization.yaml                                  | 5.6.1         |
| Kustomize overlays                                                 | 5.6.1         |
| Strategic merge patches                                            | 5.6.1         |
| JSON patches (add, remove, replace)                                | 5.6.1         |
| Kustomize transformers (commonLabels, namespace, images, replicas) | 5.6.1         |
| ConfigMapGenerator and SecretGenerator                             | 5.6.1         |
| Kustomize commands (kubectl kustomize, apply -k, diff -k)          | 5.6.1         |
| Helm v2 vs v3 differences                                          | 5.6.2         |
| Helm chart structure (Chart.yaml, values.yaml, templates/)         | 5.6.2         |
| Chart.yaml fields (name, version, appVersion, dependencies)        | 5.6.2         |
| values.yaml for configuration                                      | 5.6.2         |
| Template syntax ({{ .Values.replicaCount }})                       | 5.6.2         |
| Built-in objects (Release, Chart, Values, Files)                   | 5.6.2         |
| Template functions (quote, default, required, toYaml, nindent)     | 5.6.2         |
| Flow control (if, with, range)                                     | 5.6.2         |
| Helm commands (create, lint, package, install, upgrade, rollback)  | 5.6.2         |
| Repository management (repo add, repo update, search)              | 5.6.2         |
| Helm hooks (pre-install, post-install, etc.)                       | 5.6.2         |
| Helm testing (helm test)                                           | 5.6.2         |
...
Congratulations on completing Subchapter 5.6! You can now manage Kubernetes configuration with both Kustomize (patch-based) and Helm (template-based), choosing the right tool for each scenario.
