# 5.3.4 DNS Basics and CoreDNS: Service Discovery in Kubernetes
...
This note covers DNS fundamentals and CoreDNS deep dive. Note 5.3.1 covered Services; note 5.3.2 covered Ingress; note 5.3.3 covered Network Policies; note 5.3.5 is the subchapter review.

**Backlinks:** [5.3.1 - Services](5.3.1_Services_ClusterIP_NodePort_LoadBalancer.md) | [5.3.3 - Network Policies](5.3.3_Network_Policies.md) | [5.2.1 - Pod Fundamentals](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md) | [Module 2 - DNS](../../2-Networking/Subchapter_2.2/2.2.2_DNS_Deep_Dive.md)

---

> **Note:** The Service is still named `kube-dns` for historical reasons, even though CoreDNS replaced the original kube-dns implementation in Kubernetes 1.13+.
>
> **What is ndots:5?** If your hostname has fewer than 5 dots, Kubernetes tries appending search domains first. So `myservice` becomes `myservice.default.svc.cluster.local` before trying external DNS. This is why short names resolve inside the cluster but external lookups can be slow (they try 4-5 suffixes first).
...
**Next note (5.3.5)** is the **Subchapter 5.3 Review** – commands, cheatsheet, and scenario-based interview questions for Services, Ingress, Network Policies, and DNS/CoreDNS.

**Backlinks:** [5.3.1 - Services](5.3.1_Services_ClusterIP_NodePort_LoadBalancer.md) | [5.3.2 - Ingress](5.3.2_Ingress_Ingress_Controllers_and_Gateway_API.md) | [5.3.3 - Network Policies](5.3.3_Network_Policies.md) | [5.2.2 - StatefulSets](../Subchapter_5.2/5.2.2_Workload_Controllers_Deployments_StatefulSets_DaemonSets.md) | [Module 2 - DNS](../../2-Networking/Subchapter_2.2/2.2.2_DNS_Deep_Dive.md)
