# 5.8.5 Complete kubectl Cheatsheet and JSONPath Reference
...
**Backlinks:** [5.8.1 - Control Plane Troubleshooting](./5.8.1_Troubleshooting_Control_Plane.md) | [5.8.2 - Compute Plane Troubleshooting](./5.8.2_Troubleshooting_Compute_Plane_and_Pods.md) | [5.1.1 - Architecture](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md) | [5.3.1 - Pods](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md)
...
**Next note (5.8.10)** is the **Subchapter Review and Final Module 5 Exam** — comprehensive questions covering all 9 subchapters of Module 5.

**Backlinks:** [5.8.1 - Control Plane Troubleshooting](./5.8.1_Troubleshooting_Control_Plane.md) | [5.8.2 - Compute Plane Troubleshooting](./5.8.2_Troubleshooting_Compute_Plane_and_Pods.md) | [5.8.4 - Dashboard/k9s](./5.8.4_Dashboard_Tools_and_k9s_Cheatsheet.md) | [5.1.1 - Architecture](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md)
