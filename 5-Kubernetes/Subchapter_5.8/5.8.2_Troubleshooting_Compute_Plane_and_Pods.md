# 5.8.2 Troubleshooting Compute Plane: Worker Nodes, Pods, and Networking
...
Note 5.8.1 covers control plane troubleshooting; note 5.8.3 covers monitoring.

**Backlinks:** [5.2.1 - Pod Fundamentals](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md) | [5.4.1 - Services](../Subchapter_5.3/5.3.1_Services_ClusterIP_NodePort_LoadBalancer.md) | [5.8.1 - Control Plane](./5.8.1_Troubleshooting_Control_Plane.md)
...
**Next note (5.8.3)** covers **Monitoring with Prometheus, Grafana, and Logging**.

**Backlinks:** [5.8.1 - Control Plane](./5.8.1_Troubleshooting_Control_Plane.md) | [5.4.1 - Services](../Subchapter_5.3/5.3.1_Services_ClusterIP_NodePort_LoadBalancer.md) | [5.2.1 - Pod Fundamentals](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md)
