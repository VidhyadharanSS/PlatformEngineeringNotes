# 5.8.8 SLIs, SLOs, and Alerting Philosophy

**Backlinks:** [5.8.7 — Three Pillars](5.8.7_Three_Pillars_Metrics_Logs_Traces.md) · [5.8.9 — Incident Response](5.8.9_Incident_Response_and_On_Call.md)

**Next note:** [9.6.1 — Databases for Platform Engineers](../../9-Python/Subchapter_9.6/9.6.1_Databases_for_Platform_Engineers.md)
...
- What do I do? (Link to a runbook — see [5.8.9](5.8.9_Incident_Response_and_On_Call.md))
...
> **Analogy:** Your SLO gives you a monthly fuel budget for your car. Normal driving uses fuel at 1× rate — you'll reach the end of the month just fine. But if you start driving at 14× the normal rate, you'll burn through your monthly fuel in about 2 days. A burn-rate alert says: "you're consuming your error budget dangerously fast — slow down or you'll run out."

> **Reading tip:** The PromQL below is the most complex in this playbook. Don't try to understand every operator on first read. The **idea** is: check two time windows (1 hour and 5 minutes). If both show you're burning budget way too fast (14.4×), it's real, not a blip. The short window confirms it's still happening; the long window confirms it's sustained.
...
Next: [9.6.1 — Databases for Platform Engineers](../../9-Python/Subchapter_9.6/9.6.1_Databases_for_Platform_Engineers.md) — connection pooling, migrations, replicas, and why your DB is probably your bottleneck.
