# 5.8.4 Kubernetes Dashboard Tools and k9s Cheatsheet
...
**Backlinks:** [5.8.1 - Control Plane Troubleshooting](./5.8.1_Troubleshooting_Control_Plane.md) | [5.8.2 - Compute Troubleshooting](./5.8.2_Troubleshooting_Compute_Plane_and_Pods.md) | [5.8.3 - Monitoring](./5.8.3_Monitoring_Prometheus_Grafana_and_Logging.md) | [5.1.2 - Cluster Setup](../Subchapter_5.1/5.1.2_Cluster_Setup_kubeadm_Kind_Multi_Node.md)
...
**Next note (5.8.5)** covers the **Complete kubectl Cheatsheet and JSONPath Reference** – every kubectl command pattern organized by use case, plus JSONPath, custom columns, jq integration, and practical scripts.

**Backlinks:** [5.8.1 - Control Plane Troubleshooting](./5.8.1_Troubleshooting_Control_Plane.md) | [5.1.1 - Architecture](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md)
