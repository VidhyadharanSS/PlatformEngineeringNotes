# 5.8.3 Monitoring with Prometheus, Grafana, and Logging: Observability Stack
...
This note covers Prometheus, Grafana, and logging stacks. Notes 5.8.1 and 5.8.2 covered control plane and compute plane troubleshooting; note 5.8.4 covers Dashboard tools and k9s; note 5.8.10 is the final review.

**Backlinks:** [5.6.2 - HPA Metrics](../Subchapter_5.5/5.5.2_Autoscaling_HPA_VPA_Cluster_Autoscaler.md) | [5.8.2 - Compute Troubleshooting](./5.8.2_Troubleshooting_Compute_Plane_and_Pods.md) | [5.8.1 - Control Plane Troubleshooting](./5.8.1_Troubleshooting_Control_Plane.md) | [5.1.1 - Architecture](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md)
...
**Next note (5.8.4)** covers **Dashboard Tools and k9s** – Kubernetes Dashboard, Lens/OpenLens, k9s TUI cheatsheet, kubectx/kubens, Stern, and Headlamp.

After that: 5.8.5 (kubectl Cheatsheet + JSONPath) → 5.8.10 (Final Review and Module 5 Exam).

**Backlinks:** [5.6.2 - Metrics](../Subchapter_5.5/5.5.2_Autoscaling_HPA_VPA_Cluster_Autoscaler.md) | [5.8.1 - Pod Status](./5.8.2_Troubleshooting_Compute_Plane_and_Pods.md) | [5.1.1 - Nodes](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md) | [5.7.2 - Helm](../Subchapter_5.6/5.6.2_Helm_Charts_Values_Templates_Releases.md)
