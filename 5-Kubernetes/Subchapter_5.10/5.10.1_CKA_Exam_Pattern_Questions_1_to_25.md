...
> **⚠️ Prerequisites:** Attempt these ONLY after completing subchapters 5.1–5.9. These are exam-simulation questions that draw on the entire module. If you haven't covered a topic yet, follow the backlinks to learn it first.
...
📎 [5.3.1 Pod Fundamentals and Lifecycle](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md)
...
📎 [5.3.2 Workload Controllers](../Subchapter_5.2/5.2.2_Workload_Controllers_Deployments_StatefulSets_DaemonSets.md)
...
📎 [5.4.1 Services — ClusterIP, NodePort, LoadBalancer](../Subchapter_5.3/5.3.1_Services_ClusterIP_NodePort_LoadBalancer.md)
...
📎 [5.6.1 ConfigMaps and Secrets](../Subchapter_5.5/5.5.1_ConfigMaps_and_Secrets.md)
...
📎 [5.5.2 PersistentVolumes, PVCs, StorageClasses](../Subchapter_5.4/5.4.2_PersistentVolumes_PersistentVolumeClaims_StorageClasses.md)
...
📎 [5.6.1 ConfigMaps and Secrets](../Subchapter_5.5/5.5.1_ConfigMaps_and_Secrets.md) · [5.3.1 Pod Fundamentals](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md)
...
📎 [5.3.3 Scheduling — Taints, Tolerations, Affinity](../Subchapter_5.2/5.2.3_Scheduling_Taints_Tolerations_Affinity.md)
...
📎 [5.4.2 Ingress, Ingress Controllers, Gateway API](../Subchapter_5.3/5.3.2_Ingress_Ingress_Controllers_and_Gateway_API.md)
...
📎 [5.4.3 Network Policies](../Subchapter_5.3/5.3.3_Network_Policies.md)
...
📎 [5.8.2 RBAC Deep Dive](../Subchapter_5.7/5.7.2_RBAC_Deep_Dive.md)
...
📎 [5.8.2 RBAC Deep Dive](../Subchapter_5.7/5.7.2_RBAC_Deep_Dive.md) · [5.8.1 Authentication Methods](../Subchapter_5.7/5.7.1_Authentication_Methods.md)
...
📎 [5.6.2 Autoscaling — HPA, VPA, Cluster Autoscaler](../Subchapter_5.5/5.5.2_Autoscaling_HPA_VPA_Cluster_Autoscaler.md)
...
📎 [5.2.2 etcd Backup, Restore, and Disaster Recovery](../Subchapter_5.9/5.9.2_etcd_Backup_Restore_and_Disaster_Recovery.md)
...
📎 [5.9.1 Troubleshooting Control Plane](../Subchapter_5.8/5.8.1_Troubleshooting_Control_Plane.md)
...
- [5.3 Workloads](../Subchapter_5.2/5.2.4_Subchapter_Review.md)
- [5.4 Networking](../Subchapter_5.3/5.3.5_Subchapter_Review.md)
- [5.8 Security & RBAC](../Subchapter_5.7/5.7.6_Subchapter_Review.md)
- [5.9 Operations & Troubleshooting](../Subchapter_5.8/5.8.10_Subchapter_Review_Plus_Final_Exam.md)
