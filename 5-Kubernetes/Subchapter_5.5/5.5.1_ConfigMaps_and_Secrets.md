...
> **⚠️ Base64 is NOT encryption** — it's just encoding (like writing in a different alphabet). Anyone who can access the Secret can decode it instantly with `echo <data> | base64 -d`. For real security, enable encryption at rest (covered in 5.8) or use an external secrets manager.

This note covers ConfigMaps and Secrets. Note 5.6.2 covers autoscaling; note 5.6.3 is the subchapter review.

**Backlinks:** [5.3.1 - Workloads](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md) (Pods) | [Module 1 - Env Vars](../../1-Linux/Subchapter_1.1/1.1.2_Environment_Variables_and_Shell_Initialization.md) | [5.5.1 - Volumes](../Subchapter_5.4/5.4.1_Ephemeral_Volumes_emptydir_hostPath.md)
...
**Backlinks:** [Module 1 - Env Vars](../../1-Linux/Subchapter_1.1/1.1.2_Environment_Variables_and_Shell_Initialization.md) | [5.5.1 - Volumes](../Subchapter_5.4/5.4.1_Ephemeral_Volumes_emptydir_hostPath.md) | [5.3.1 - Pods](../Subchapter_5.2/5.2.1_Pod_Fundamentals_and_Lifecycle.md)
