...
**Backward references:** Load balancing from Module 2 (Layer 4 load balancer for API servers); etcd from 5.1.1 (distributed key-value store); kubeadm from 5.1.2 (cluster setup).
...
* etcd from 5.1.1 (distributed key-value store)

* kubeadm from 5.1.2 (cluster initialization)

* Load balancing from Module 2 (L4 load balancer concepts)

* Taints/tolerations from Module 5 (covered later, but introduced here)
