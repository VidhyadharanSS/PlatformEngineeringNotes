...
> **⚠️ CKA exam topic:** etcd backup/restore is critical for the CKA exam but not needed for daily K8s use. On Kind/Minikube you cannot practice these commands directly. Learn the concepts now; practice on a kubeadm cluster later.
...
**Backlinks:** [5.1.1 - Architecture](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md) (etcd architecture) | [5.2.1 - HA Cluster](./5.2.1_HA_Cluster_Architecture_Multi_Master.md) (multi-master) | [Module 1 - Cron](../../1-Linux/Subchapter_1.2/1.2.2_Systemd_and_Service_Management.md) (automated backups)
