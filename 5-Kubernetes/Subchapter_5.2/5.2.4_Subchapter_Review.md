# 5.2.4 Subchapter Review: Cheatsheet and Interview Prep

This review covers the material presented in Notes 5.2.1 (Pod Fundamentals), 5.2.2 (Workload Controllers), and 5.2.3 (Scheduling).

**Backlinks:** [5.2.1 - Pod Fundamentals](5.2.1_Pod_Fundamentals_and_Lifecycle.md) | [5.2.2 - Workload Controllers](5.2.2_Workload_Controllers_Deployments_StatefulSets_DaemonSets.md) | [5.2.3 - Scheduling](5.2.3_Scheduling_Taints_Tolerations_Affinity.md)
...
| Topic                                                               | Found in Note |
| ------------------------------------------------------------------- | ------------- |
| Pod specification (containers, probes, volumes, env)                | 5.2.1         |
| Init containers                                                     | 5.2.1         |
| Sidecar containers                                                  | 5.2.1         |
| ReplicaSet                                                          | 5.2.1         |
| Deployment (create, scale, update, rollout, rollback)               | 5.2.1         |
| Deployment strategies (RollingUpdate, Recreate)                     | 5.2.1         |
| StatefulSet (stable network ID, ordered startup, PVCs)              | 5.2.1         |
| Headless service for StatefulSet                                    | 5.2.1         |
| Pod status conditions                                               | 5.2.1         |
| Node selectors                                                      | 5.2.2         |
| Taints and tolerations (NoSchedule, PreferNoSchedule, NoExecute)    | 5.2.2         |
| Node affinity (requiredDuringScheduling, preferredDuringScheduling) | 5.2.2         |
| Pod affinity and anti-affinity                                      | 5.2.2         |
| Topology spread constraints                                         | 5.2.2         |
| Resource requests and limits (scheduling impact)                    | 5.2.2         |
| Troubleshooting scheduling issues                                   | 5.2.2         |
