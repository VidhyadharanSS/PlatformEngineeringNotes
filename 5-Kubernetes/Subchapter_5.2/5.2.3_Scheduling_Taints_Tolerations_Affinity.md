...
**Backlinks:** [5.1.1 - Architecture](../Subchapter_5.1/5.1.1_K8s_Architecture_Components.md) | [5.3.1 - Pod Fundamentals](5.2.1_Pod_Fundamentals_and_Lifecycle.md) | [5.3.2 - Controllers](5.2.2_Workload_Controllers_Deployments_StatefulSets_DaemonSets.md)
...
**Next note (5.3.4)** will be the Subchapter Review for Workloads and Scheduling, including a cheatsheet and scenario-based interview questions.

**Backlinks:** [5.3.1 - Workloads](5.2.1_Pod_Fundamentals_and_Lifecycle.md) (labels) | [Module 4 - Resources](../../4-Docker/Subchapter_4.3/4.3.1_Container_Lifecycle_and_Resource_Management.md) (requests/limits) | [5.2.1 - HA Architecture](../Subchapter_5.9/5.9.1_HA_Cluster_Architecture_Multi_Master.md) (control plane taints)
